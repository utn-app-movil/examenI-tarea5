...
class nav_container(
    ...
    private var nav_imageUri: String
    ...
    init {
        Id = nav_ContainerNum // ContainerNum como Id
    }
    ...
    var containerNum: String
        ...
        set(value) {
            ...
            Id = value // se actualiza Id cuando se cambia containerNum
        }
    ...
    var imageUri: String
        get() = this.nav_imageUri
        set(value) {
            this.nav_imageUri = value
        }
}
